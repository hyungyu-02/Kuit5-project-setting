        ...
        setContent {
            KuitProjectSettingTheme {
                ...
                val bottomNavItems = listOf(
                    BottomNavItem("홈", route = Route.Home.route, R.drawable.ic_home),
                    BottomNavItem("일기", route = Route.Diary.route, R.drawable.ic_diary),
                    BottomNavItem("마이페이지", route = Route.My.route, R.drawable.ic_my)
                )
